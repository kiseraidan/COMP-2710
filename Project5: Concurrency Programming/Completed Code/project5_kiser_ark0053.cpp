 ...
 * Author: Aidan Kiser
 * UserID: ark0053
 * Filename: project5_kiser_ark0053.cpp
 * Compile: g++ project5_kiser_ark0053.cpp -o project5_LastName_UserID.cpp -lpthread
 * Script: script project5_LastName_UserID.script
 * Run: ./project5_LastName_UserID
